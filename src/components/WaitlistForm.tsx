...
import { Loader2, Mail, User, Globe, Wallet, CreditCard, Sparkles } from 'lucide-react'
...
export function WaitlistForm({ onSuccess }: WaitlistFormProps) {
  ...
  const onSubmit = async (data: WaitlistFormData) => {
    ...
    if (!supabase) {
      setError('Le service est temporairement indisponible. Veuillez reessayer plus tard.')
    ...
    try {
      ...
      if (insertError) {
        // Verifier si c'est un doublon d'email
